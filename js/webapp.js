...
const chestMaterialAPINames = [
    "CHEST", "ENDER_CHEST", "TRAPPED_CHEST", "BARREL", "SHULKER_BOX", "WHITE_SHULKER_BOX", "ORANGE_SHULKER_BOX", "MAGENTA_SHULKER_BOX", "LIGHT_BLUE_SHULKER_BOX", "YELLOW_SHULKER_BOX", "LIME_SHULKER_BOX", "PINK_SHULKER_BOX", "GRAY_SHULKER_BOX", "LIGHT_GRAY_SHULKER_BOX", "CYAN_SHULKER_BOX", "PURPLE_SHULKER_BOX", "BLUE_SHULKER_BOX", "BROWN_SHULKER_BOX", "GREEN_SHULKER_BOX", "RED_SHULKER_BOX", "BLACK_SHULKER_BOX"]
...
const particleAPINames = [
    "ASH", "BLOCK_CRACK", "BLOCK_DUST", "BLOCK_MARKER", "BUBBLE_COLUMN_UP", "BUBBLE_POP", "CAMPFIRE_COSY_SMOKE", "CAMPFIRE_SIGNAL_SMOKE", "CLOUD", "COMPOSTER", "CRIMSON_SPORE", "CRIT", "CRIT_MAGIC", "CURRENT_DOWN", "DAMAGE_INDICATOR", "DOLPHIN", "DRAGON_BREATH", "DRIP_LAVA", "DRIP_WATER", "DRIPPING_DRIPSTONE_LAVA", "DRIPPING_DRIPSTONE_WATER", "DRIPPING_HONEY", "DRIPPING_OBSIDIAN_TEAR", "DUST_COLOR_TRANSITION", "ELECTRIC_SPARK", "ENCHANTMENT_TABLE", "END_ROD", "EXPLOSION_HUGE", "EXPLOSION_LARGE", "EXPLOSION_NORMAL", "FALLING_DRIPSTONE_LAVA", "FALLING_DRIPSTONE_WATER", "FALLING_DUST", "FALLING_HONEY", "FALLING_LAVA", "FALLING_NECTAR", "FALLING_OBSIDIAN_TEAR", "FALLING_SPORE_BLOSSOM", "FALLING_WATER", "FIREWORKS_SPARK", "FLAME", "FLASH", "GLOW", "GLOW_SQUID_INK", "HEART", "ITEM_CRACK", "LANDING_HONEY", "LANDING_LAVA", "LANDING_OBSIDIAN_TEAR", "LAVA", "MOB_APPEARANCE", "NAUTILUS", "NOTE", "PORTAL", "REDSTONE", "REVERSE_PORTAL", "SCRAPE", "SLIME", "SMALL_FLAME", "SMOKE_LARGE", "SMOKE_NORMAL", "SNEEZE", "SNOW_SHOVEL", "SNOWBALL", "SNOWFLAKE", "SOUL", "SOUL_FIRE_FLAME", "SPELL", "SPELL_INSTANT", "SPELL_MOB", "SPELL_MOB_AMBIENT", "SPELL_WITCH", "SPIT", "SPORE_BLOSSOM_AIR", "SQUID_INK", "SUSPENDED", "SUSPENDED_DEPTH", "SWEEP_ATTACK", "TOTEM", "TOWN_AURA", "VIBRATION", "VILLAGER_ANGRY", "VILLAGER_HAPPY", "WARPED_SPORE", "WATER_BUBBLE", "WATER_DROP", "WATER_SPLASH", "WATER_WAKE", "WAX_OFF", "WAX_ON", "WHITE_ASH"]

const professionAPINames = [
...
window.onload = function () {
    ...
    document.getElementById('chest-material-API-names').innerHTML = convertToDatalist(chestMaterialAPINames);
    document.getElementById('enchantments-API-name').innerHTML = convertToDatalist(enchantmentAPINames);
    document.getElementById('potion-effects-API-name').innerHTML = convertToDatalist(potionEffectsAPINames);
    document.getElementById('profession-API-names').innerHTML = convertToDatalist(professionAPINames);
    document.getElementById('interaction-type-API-names').innerHTML = convertToDatalist(interactionTypeAPINames);
...
function updateTreasureChestFilenames() {
    treasureChestFilenames = updateAnyFilenames('card-treasure-chest', 'treasure-chest-filename-names');
}
...
function updateAnyFilenames(cardType, datalistID) {
    ...
    for (let i = 0; i < allElements.length; i++) {
        ...
        if (filenameRow === undefined || filenameRow[0] === undefined || filenameRow[0] === null) continue;
 ...
 */
function addEntry() {
    document.getElementById('add-entry').before(document.getElementById('template-main-container').content.cloneNode(true));
}
...
function generateYMLText(entry) {
        ...
        if (individualEntries.length === 1) {
            ...
            if (individualEntries[0].value !== undefined && individualEntries[0].value !== "")
                if (fieldsObject[key] === undefined || fieldsObject[key] === "")
                    ...
                    fieldsObject[key] = convertToConfigFormat(configFields[i], individualEntries[0].value, true);
                else
            ...
            completeRowString = completeRowString.slice(0, 3) + "\"" + completeRowString.slice(3, completeRowString.length) + "\"";
            if (fieldsObject[key] === undefined)
                fieldsObject[key] = completeRowString;
            else
                fieldsObject[key] += completeRowString;
    ...
    for (const key in fieldsObject) {
        if (key !== "filename")
            finalString += key + ": " + fieldsObject[key] + "\n";
    }
